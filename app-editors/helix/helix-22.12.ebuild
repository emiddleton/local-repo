...
LANGUAGES=(
	...
	"markdown https://github.com/MDeiml/tree-sitter-markdown a7de4be29783a6e25f3240c90afea52f2417faa3 tree-sitter-markdown"
	...
	"ocaml https://github.com/tree-sitter/tree-sitter-ocaml 23d419ba45789c5a47d31448061557716b02750a ocaml"
	"ocaml-interface https://github.com/tree-sitter/tree-sitter-ocaml 23d419ba45789c5a47d31448061557716b02750a interface"
	...
	"solidity https://github.com/slinlee/tree-sitter-solidity 9004b86531cb424bd379424cf7266a4585f2af7d"
	...
	"tsx https://github.com/tree-sitter/tree-sitter-typescript 6aac031ad88dd6317f02ac0bb27d099a553a7d8c tsx"
	"twig https://github.com/gbprod/tree-sitter-twig 807b293fec3fead64f54c64fdf6fb05516c032b9"
	"typescript https://github.com/tree-sitter/tree-sitter-typescript 6aac031ad88dd6317f02ac0bb27d099a553a7d8c typescript"
	...
	"v https://github.com/vlang/vls 3e8124ea4ab80aa08ec77f03df53f577902a0cdd tree_sitter_v"
	...
	"wast https://github.com/wasm-lsp/tree-sitter-wasm 2ca28a9f9d709847bf7a3de0942a84e912f59088 wast"
...
language_uris() {
	for line in "${LANGUAGES[@]}"; do
		read -r name url commit subpath <<< "${line}"
...
src_prepare() {
	if use grammar; then
		for line in "${LANGUAGES[@]}"; do
			...
			cp -r ${WORKDIR}/${url##*/}-${commit}/${subpath}/* ${S}/runtime/grammars/sources/${name} || die
		done
	fi
